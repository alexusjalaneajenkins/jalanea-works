        ...
        <div className="relative max-w-4xl mx-auto px-4 py-6 h-[calc(100vh-80px)] flex flex-col">
            ...
            <div className="flex items-center justify-between mb-4 md:mb-6">
                <div className="flex items-center gap-2 md:gap-3">
                    <div className="p-2 md:p-2.5 bg-gradient-to-br from-gold to-amber-500 rounded-lg md:rounded-xl text-black shadow-[0_0_20px_rgba(255,196,37,0.4)]">
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        ...
                        {savedThreads.length > 0 && (
                            <span className="bg-gold text-black text-[10px] font-bold px-1.5 py-0.5 rounded-full">
                                {savedThreads.length}
                            </span>
                        )}
                    </button>

...
Make it engaging and easy to absorb while commuting!`;
    ...
    return (
        <div className="min-h-screen bg-[#020617] pb-16 relative">
            ...
            {/* Toast Notification */}
            {toast && (
                <div className={`fixed top-4 right-4 z-50 px-4 py-3 rounded-xl shadow-lg flex items-center gap-3 animate-in slide-in-from-right duration-300 backdrop-blur-xl ${
                    toast.type === 'success'
            ...
            <div className="sticky top-0 z-20 pt-4 pb-4 bg-[#020617]/80 backdrop-blur-xl border-b border-white/10">
                <div className="space-y-3">
                    <div className="flex flex-col md:flex-row gap-3">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="flex items-center gap-2 bg-gold hover:bg-gold-light text-black font-bold px-6 py-3 rounded-xl shadow-[0_0_20px_rgba(255,196,37,0.3)] hover:shadow-[0_0_30px_rgba(255,196,37,0.5)] transition-all whitespace-nowrap disabled:opacity-50"
                            >
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                        <span className="text-xs font-bold text-slate-500 uppercase tracking-wider mr-1">Filters:</span>
                        ...
                        {(isRemote || isOnsite || activeFilter) && (
                            <button
                                ...
                                className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-medium text-slate-500 hover:text-red-400 transition-colors"
                            >
                                ✕ Clear
                            </button>
                        )}
